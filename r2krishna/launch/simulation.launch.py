...
def generate_launch_description():
    ...
    # Point to the 'share' directory for package:// resolution
    ...
    # Create the new path string manually to guarantee no data loss
    new_path_list = [
        arena_models_path,
        r2_share,
        arena_share,
        pkg_arena,
        pkg_r2,
        current_gz_path # Append existing system paths at the end
    ]
